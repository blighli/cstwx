(function(a){
    ...
    Lottery.prototype = {
        createElement: function(t, e) {
            ...
            // n.setAttribute("id", "sbyg");
            // var context = n.getContext("2d");
            // this.maskCtx.fillStyle = "blue";
            // this.maskCtx.font = "bold 66px Arial";
            // this.maskCtx.fillText("Zibri", 100, 100);
            return n
            ...
            if ("color" == this.coverType)
                ...
                t.onload = function() {
                    ...
                    // 渐变
                    var i = e.maskCtx.createLinearGradient(0, 0, e.width, 0);
                    i.addColorStop("0", "#666");
                    i.addColorStop("1.0", "#666");
                    ...
                    // if(e.vail){
                        ...
                        n = e.showText;
                        // console.log();
                        e.maskCtx.fillText(n, e.width / 2 - e.maskCtx.measureText(n).width / 2, 380);
